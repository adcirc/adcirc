...
adcirc_set_module_directory(adcirc)
target_link_libraries(adcirc PRIVATE adcirc::compiler_flags adcirc::option_flags adcirc::link_libraries)

if(ADDITIONAL_FLAGS_ADCIRC)
  target_compile_options(adcirc PRIVATE ${ADDITIONAL_FLAGS_ADCIRC})
endif()
