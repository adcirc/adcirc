...
#
# ######################################################################################################################
if(NOT BUILD_ADCSWAN OR NOT PERL_FOUND)
  return()
endif()
...
set(ADCSWAN1_SOURCES
    ...
    ${CMAKE_CURRENT_SOURCE_DIR}/src/ramp.F90
...
add_dependencies(templib_swan1serial generate_swan_serial_sources)
add_dependencies(templib_swan2serial generate_swan_serial_sources)

# Configure SWAN object libraries
adcirc_set_module_directory(templib_swan1serial)
adcirc_set_module_directory(templib_swan2serial)
target_link_libraries(templib_swan1serial PRIVATE adcirc::swan_compiler_flags)
target_link_libraries(templib_swan2serial PRIVATE adcirc::swan_compiler_flags)

if(ADDITIONAL_FLAGS_SWAN)
  target_compile_options(templib_swan1serial PRIVATE ${ADDITIONAL_FLAGS_SWAN})
  target_compile_options(templib_swan2serial PRIVATE ${ADDITIONAL_FLAGS_SWAN})
endif()

# Configure ADCIRC+SWAN object library
adcirc_set_module_directory(templib_adcswan1)
target_link_libraries(templib_adcswan1 PRIVATE adcirc::compiler_flags adcirc::option_flags adcirc::link_libraries)

if(ADDITIONAL_FLAGS_ADCIRC)
  target_compile_options(templib_adcswan1 PRIVATE ${ADDITIONAL_FLAGS_ADCIRC})
endif()

# Configure adcswan executable
adcirc_set_module_directory(adcswan)
target_link_libraries(adcswan PRIVATE adcirc::compiler_flags adcirc::option_flags adcirc::link_libraries)

if(ADDITIONAL_FLAGS_ADCIRC)
  target_compile_options(adcswan PRIVATE ${ADDITIONAL_FLAGS_ADCIRC})
endif()

# Handle datetime for SWAN
if(ENABLE_DATETIME)
  target_compile_definitions(templib_swan2serial PRIVATE DATETIME)
  target_include_directories(templib_swan2serial PRIVATE ${CMAKE_CURRENT_BINARY_DIR}/CMakeFiles/mod/datetime_fortran)
  target_link_libraries(templib_swan2serial PRIVATE datetime)
endif()
...
target_link_libraries(templib_swan2serial PRIVATE templib_swan1serial templib_adcswan1)
target_link_libraries(templib_adcswan1 PRIVATE templib_swan1serial)
target_link_libraries(adcswan PRIVATE templib_adcswan1 templib_swan2serial templib_swan1serial)
