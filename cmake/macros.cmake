...
MACRO(addNetCDF TARGET)
    IF(NETCDF_WORKING)
        ...
        TARGET_INCLUDE_DIRECTORIES(${TARGET} PRIVATE ${NETCDFHOME}/include)
        TARGET_LINK_LIBRARIES(${TARGET} netcdf netcdff)
...
MACRO(addXDMF TARGET)
    IF(XDMF_WORKING)
        ...
        TARGET_LINK_LIBRARIES(${TARGET} XdmfCore XdmfUtils Xdmf)
    ENDIF(XDMF_WORKING)
ENDMACRO(addXDMF)
