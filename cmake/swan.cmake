...
#
# ######################################################################################################################
if(NOT BUILD_SWAN OR NOT PERL_FOUND)
  return()
endif()
...
adcirc_set_module_directory(swan)
target_link_libraries(swan PRIVATE adcirc::swan_compiler_flags)

if(ADDITIONAL_FLAGS_SWAN)
  target_compile_options(swan PRIVATE ${ADDITIONAL_FLAGS_SWAN})
endif()
