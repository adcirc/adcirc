!******************************************************************************
! MODULE WEIR_BOUNDARY
!   Written by Zachary Cobell, 2012/03/12
...
!   HAVE THEIR VALUES SET USING THIS ROUNTINE.
...
!...............OPEN THE TIME VARYING WEIR FILE IF FOUND
    ...
    NODES_TVW(:) = -1
!...............WRITE NAMELIST INPUT TO SCRATCH FILE
    ...
    EPS = EPSILON(1.0D0)
    ISNULL = .FALSE. 
    IF(ABS(CHECKNUMBER+99999D0) <= EPS)THEN
        ISNULL = .TRUE. 
    ENDIF
    END FUNCTION ISNULL
