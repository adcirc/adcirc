...
module mod_astronomic
   ...
   public :: t_astronomic_values, DeltaVarepsL, varepsilon0_ecliptic, DeltaPsiL, L0_DEG, &
             OMEGA_DEG, F_DEG, MP_DEG, M_DEG, D_DEG, LP_DEG, JULIAN_CENTURIES, eclip2eq, &
             km2au, eccentricity_earth_orbit, GMST_DEG, EarthRadiusm, MassRatioSunEarth, &
             MassRatioMoonEarth, EarthRadiuskm, EarthRadiusAU, JULIANDAY
