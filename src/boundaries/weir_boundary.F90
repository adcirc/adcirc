...
module TIME_VARYING_WEIR_BOUNDARY
   ...
   use WEIR_DATA, only: BARINHT1, BARINHT2, BARLANHT1, BARLANHT2, &
...
module WEIR_FLUX
   ...
   use TIME_VARYING_WEIR_BOUNDARY, only: COMPUTE_BARRIER_HEIGHT, &
                                         BAR_DEG
   use WEIR_DATA, only: BARMIN, BARLANHT1, BARLANHT2, &
...
#ifdef ORIGWEIR
   public :: COMPUTE_INTERNAL_BOUNDARY_FLUX_ORIG
#endif
