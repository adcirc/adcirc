...
contains
   ...
   subroutine HEAVENLY_OBJS_COORDS_FROM_TABLE(self, MoonSunCoor, julian_date_loc, ierr, UniformDT)
      ...
      real(8), intent(inout) :: MoonSunCoor(3, 2)
      integer, intent(out) :: ierr
      logical, intent(in), optional :: UniformDT

      integer :: j, ii
      real(8) :: julian_datetime_2000, seconds_between
      logical :: UniformRankSearch
      real(8) :: ratmp(4)
      logical :: match
      integer :: idarr(4)

      uniformRankSearch = .false.
   ...
   subroutine adjust_RA(RA, fadjust)
      ...
      logical, intent(inout), optional :: fadjust
