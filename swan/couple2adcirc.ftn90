...
!Casey 080905: Added these variables.
      INTEGER, ALLOCATABLE :: SWAN_IRECVLOC(:,:)
      INTEGER              :: SWAN_NEIGHPROC
      INTEGER, ALLOCATABLE :: SWAN_NNODRECV(:)

      CONTAINS



      SUBROUTINE MakeBoundariesReflective(ivert, ac2, anybin )
      ...
      LOGICAL,INTENT(INOUT)  :: anybin(MDC,MSC)
      LOGICAL                :: IntoDomain
