...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
 ...
 IM=IGDTMPL(8)
 JM=IGDTMPL(9)
 RLAT1=DBLE(IGDTMPL(10))*1.E-6
 RLON1=DBLE(IGDTMPL(11))*1.E-6
 IROT=MOD(IGDTMPL(12)/8,2)
 SLAT=DBLE(ABS(IGDTMPL(13)))*1.E-6
 SLATR=SLAT/DPR
 ORIENT=DBLE(IGDTMPL(14))*1.E-6
 DX=DBLE(IGDTMPL(15))*1.E-3
 DY=DBLE(IGDTMPL(16))*1.E-3
